...
public interface IContTemplate {
	 ...
	 * @throws 
	 * @author  zhy
	 * @date 2016-10-26 下午4:37:00 
	 * @version v1.0
	 * 更改记录(有修改时记录，并对方法中修改的代码块加注释)
	 */
	List<ArticleEntity> getArticlesByColid(String channelId,String columnId,String searchType,String limits,boolean isStick,boolean isColid);
	/**
	 * 获取频道名称
	 * @Title queryChanname 
	 * @Description TODO
	 ...
	 * 更改记录(有修改时记录，并对方法中修改的代码块加注释)
	 */
	List<ArticleEntity> getStickArticlesByColid(String goods_class_id,String column_id);
	/**
	 * 查询搜索框文字
	 ...
	 * @throws 
	 * @author  zhy
	 * @date 2019-1-29 下午6:30:53 
	 * @version v1.0
	 * 更改记录(有修改时记录，并对方法中修改的代码块加注释)
	 */
	BrandEntity getBrandInfo(String brand_id);
	
	/**
	 * 文章详情
	 * @Title quertArticleInfo 
	 * @Description TODO
	 * @param articleId
	 * @param pageUrl
	 * @param title
	 ...
	 * @throws 
	 * @author  zhy
	 * @date 2019-2-21 下午4:44:24 
	 * @version v1.0
	 * 更改记录(有修改时记录，并对方法中修改的代码块加注释)
	 */
	ArticleEntity quertArticleInfo(String articleId,String pageUrl,String title);
