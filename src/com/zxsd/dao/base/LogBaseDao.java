...
public class LogBaseDao<T> {
    ...
    protected static Logger logger = LoggerFactory.getLogger(LogBaseDao.class);
    ...
    public void setDataSourcelog(DataSource dataSourcelog) {
        ...
        jdbcTemplatelog = new JdbcTemplate(dataSourcelog);
    }

    public int insertAndGetKey() {
        KeyHolder keyHolder = new GeneratedKeyHolder();
        this.getJdbcTemplatelog().update(new PreparedStatementCreator(){
    ...
    public void exectue(String sql) throws ServiceException {
        try{
            this.getJdbcTemplatelog().execute(sql);
        }catch(Exception e){
			/*e.printStackTrace();
    ...
    public boolean update(String sql,final Object... values){
        try{
            int result = this.getJdbcTemplatelog().update(sql, values);
            if(result < 1){
                return false;
            }
            return true;
    ...
    public boolean bachUpdate(String sql,List<Object[]> batchArgs){
        try{
            int[] result = this.getJdbcTemplatelog().batchUpdate(sql, batchArgs);
            if(result != null){
    ...
    protected long getCount(String sql,Object [] args){
        try{
            ...
            long res = this.getJdbcTemplatelog().queryForLong(sqlStr,args);
            return res;
        }catch(Exception e){
		/*	e.printStackTrace();
			logger.error(exceptionMsg, e.getCause());
    ...
    public List queryList(String sql, Object [] args, RowMapper<Object> rowMapper){
        try{
            return this.getJdbcTemplatelog().query(sql, args, rowMapper);
        }catch(Exception e){
			/*e.printStackTrace();
			logger.error(exceptionMsg, e.getCause());
			throw new ServiceException(exceptionMsg);*/
    ...
    public  List queryList(String sql,Object [] args){
        try{
            return this.getJdbcTemplatelog().queryForList(sql, args);
        }catch(Exception e){
		/*	e.printStackTrace();
			logger.error(exceptionMsg, e.getCause());
			throw new ServiceException(exceptionMsg);*/
    ...
    public  Object queryObject(String sql,Object [] args,RowMapper<Object> rowMapper){
        try{
            Object t= null;
            List<Object> list =  this.getJdbcTemplatelog().query(sql, args, rowMapper);
